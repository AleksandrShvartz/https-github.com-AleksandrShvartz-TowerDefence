...
private:
    std::random_device m_rd; // ”стройство генерации случайных чисел
    std::mt19937 m_mt;       // —тандартный генератор случайных чисел
...
#endif // RANDOM_HPP
/*
https://evileg.com/ru/post/306/#header_QRandomGenerator
*/